...
function createProfileDescription(obj) {
  ...
  } else return `My name is ${obj.name} and I don't like to code.`;
}
...
//Exercise 6
function updateCoinMachine(coinMachineObj, newCoin) {
  coinMachineObj[newCoin]++;
...
//Exercise 7
function updatePosition(coordinates, str) {
  /*
...
//Exercise 10
function addCoins(coinCollectionArray, coin) {
  /*
  ...
  */
  switch (coin) {
    case "1p":
      coinCollectionArray[0].push(coin);
      break;
    case "2p":
      coinCollectionArray[1].push(coin);
      break;
    case "5p":
      coinCollectionArray[2].push(coin);
      break;
    case "10p":
      coinCollectionArray[3].push(coin);
      break;
  }

  return coinCollectionArray;
}
